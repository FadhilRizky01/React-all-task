      ...
      <div className="bg-gray-200 min-h-screen dark:bg-slate-800 dark:text-white">
        ...
        <div className="w-full flex justify-center items-center">
          <input
            ...
            className="px-3 py-2 mt-8 border shadow rounded w-full md:w-[900px]  text-sm placeholder:text-slate-400 focus:outline-none focus:ring-1 focus:ring-sky-500 focus:border-sky-500 dark:text-black"
          />
        </div>
        {/* END INPUT */}
